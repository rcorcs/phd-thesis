...
\chapter{Merging Pairs of Functions} \label{chap:fm-operation}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% FMSA %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Particularly for the function-merging, we are concerned with the alphabet consisting of all possible typed instructions and labels.
